...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column('pull_usercijob', 'ci_job')
        db.delete_column('pull_usercijob', 'ci_job_id')

    def backwards(self, orm):
        raise RuntimeError("Cannot reverse this migration. 'UserCiJob.ci_job' and its values cannot be restored.")
