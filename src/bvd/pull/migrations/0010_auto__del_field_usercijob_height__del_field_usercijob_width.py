...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserCiJob.height'
        db.delete_column('pull_usercijob', 'height')

        # Deleting field 'UserCiJob.width'
        db.delete_column('pull_usercijob', 'width')


    def backwards(self, orm):
        # Adding field 'UserCiJob.height'
        db.add_column('pull_usercijob', 'height',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserCiJob.width'
        db.add_column('pull_usercijob', 'width',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)
