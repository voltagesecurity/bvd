...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserCiJob.ci_server'
        db.add_column('pull_usercijob', 'ci_server',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='updateciserverfield', to=orm['pull.CiServer']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserCiJob.ci_server'
        db.delete_column('pull_usercijob', 'ci_server_id')
