...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.show_rally'
        db.add_column('pull_product', 'show_rally',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Product.rally_release_name'
        db.add_column('pull_product', 'rally_release_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.show_rally'
        db.delete_column('pull_product', 'show_rally')

        # Deleting field 'Product.rally_release_name'
        db.delete_column('pull_product', 'rally_release_name')
    ...
    models = {
        ...
        'pull.product': {
            ...
            'rally_release_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'show_rally': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'pull.usercijob': {
