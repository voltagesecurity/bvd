...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserCiJob.appletv'
        db.add_column('pull_usercijob', 'appletv',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserCiJob.appletv_active'
        db.add_column('pull_usercijob', 'appletv_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserCiJob.appletv'
        db.delete_column('pull_usercijob', 'appletv')

        # Deleting field 'UserCiJob.appletv_active'
        db.delete_column('pull_usercijob', 'appletv_active')
