...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserCiJob.icon'
        db.alter_column('pull_usercijob', 'icon', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'UserCiJob.icon'
        db.alter_column('pull_usercijob', 'icon', self.gf('django.db.models.fields.CharField')(default='checkmark.png', max_length=100))
